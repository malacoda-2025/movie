  ...
  return (
    <div className="min-h-screen bg-black text-white">
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
              <div className="text-center group">
                <div className="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden group-hover:scale-105 transition-transform"
                     style={{ backgroundImage: `url("cast/jonathan.png")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                  {/*
              ...
              <div className="text-center group">
                <div className="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden group-hover:scale-105 transition-transform"
                     style={{ backgroundImage: `url("cast/q.png")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                  {/*
                  <div className="w-full h-full flex items-center justify-center text-gray-500">
                    <Users className="w-12 h-12" />
                  </div>
              ...
              <div className="text-center group">
                <div className="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden group-hover:scale-105 transition-transform"
                     style={{ backgroundImage: `url("cast/leddy.png")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
              <div className="text-center group">
                ...
                <p className="text-sm text-gray-500 mt-2">Guillermo R. Rodríguez is a writer, director, editor and producer from San Juan, Puerto
                  Rico. Guillermo is also Assistant Professor of Cinema and Television Arts at California State
                  University, Northridge. He is the author of the book Spanish Meta-Art and Contemporary
                  Cinema: Mirrors to the Unconscious (Bloomsbury, 2023). His directorial debut The Shadows premiered at Los Angeles's Outfest LGBTA Film Festival in their Dramatic Competition and is currently available on Amazon Prime.</p>
              </div>
              <div className="text-center group">
                <div className="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden group-hover:scale-105 transition-transform">
                  <div className="w-full h-full flex items-center justify-center text-gray-500">
                ...
                <p className="text-sm text-gray-500 mt-2">Scott Langer is the founder of Ninety 90 Pictures. A graduate of the University of Colorado-Boulder with a B.A. in Film Studies, he also trained in Method Acting at the Lee Strasberg Institute in New York. After overcoming years of addiction with the support of fellow artists and family, Scott turned to creating art as a way to sustain his sobriety. His plays Amanda the Barbarian and Thank You For Loving Me premiered at the Hollywood Fringe Festival, with the latter winning the Producers’ Encore Award. Inspired while working on the short film Stay Calm in 2019, Scott founded Ninety 90 Pictures to create safe, collaborative sets that support artists at every stage of recovery.</p>
              </div>
              <div className="text-center group">
                <div className="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden group-hover:scale-105 transition-transform">
                  <div className="w-full h-full flex items-center justify-center text-gray-500">
                ...
                <p className="text-sm text-gray-500 mt-2">Erik Boccio is a multi-award-winning filmmaker based in Southern California. His work spans feature films, shorts, music videos, and VR projects, with millions of views across streaming, television, and web platforms. Boccio’s feature debut, Night of the Bastard, premiered at Arrow Video FrightFest and Sitges, later securing distribution through MPI Media, Dark Sky Films, and Shudder. His acclaimed horror-comedy short Brutal Realty, Inc. earned multiple festival awards before premiering on Screambox TV in 2025. Beginning his career in New York directing music videos for MTV, FUSE, and BET, Boccio has since built a diverse body of work while also serving as an Associate Professor of Cinema & Television Arts at California State University, Northridge.</p>
              </div>
              <div className="text-center group">
                <div className="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden group-hover:scale-105 transition-transform">
                  <div className="w-full h-full flex items-center justify-center text-gray-500">
                ...
                <p className="text-sm text-gray-500 mt-2">Martin Jarmick is a digital artist, developer, and professor at California State University, Northridge. Raised in Seattle and San Francisco, he earned his PhD in Digital Art and Experimental Media from the University of Washington. His work blends cinema, poetry, and technology, often exploring themes of mental health, transformation, and the fragility of reality. Collaborating across disciplines—from choreographers and musicians to engineers and game designers—Jarmick creates immersive, interactive media that expand narrative patterns and invite audiences into intimate, performative experiences.</p>
              </div>
              {/*}
              <div className="text-center group">
                <div className="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden group-hover:scale-105 transition-transform">
      ...
      <section id="media" className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold mb-12 text-center text-red-500 font-bodoni">Clips from the Film</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="group cursor-pointer">
                <div className="aspect-video bg-gray-800 rounded-lg overflow-hidden relative group-hover:scale-105 transition-transform">
                  <div className="w-full h-full flex items-center justify-center text-gray-500">
                    <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className="group">
                  <div className="aspect-video bg-gray-800 rounded-lg overflow-hidden group-hover:scale-105 transition-transform">
                    <div className="w-full h-full flex items-center justify-center text-gray-500">
                      <div className="text-center">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[{id: 1, src: 'PXL_20250730_162009659.jpg'}, {id: 2, src: 'PXL_20250730_163059819.jpg'}, {id: 3, src: 'PXL_20250731_185556162.jpg'}, {id: 4, src: 'PXL_20250730_165146438.MP.jpg'}, {id: 5, src: 'PXL_20250730_170915414.MP.jpg'}, {id: 6, src: 'PXL_20250730_173044126.MP.jpg'}, {id: 7, src: 'PXL_20250730_162009659.jpg'}, {id: 8, src: 'PXL_20250730_181740885.jpg'}].map((i) => (
                <div key={i.id} className="group">
                  <div className="aspect-square rounded-lg overflow-hidden group-hover:scale-105 transition-transform"
                       style={{ backgroundImage: `url("stills/${i.src}")`, backgroundSize: 'cover', backgroundPosition: 'center' }}
                  >
                    {/*
                    <div className="w-full h-full flex items-center justify-center text-gray-500">
                      <div className="text-center">
